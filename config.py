...
class RobotVertDefConfig(Config):
	...
	def __init__(self):
		...
		## Front Legs
		FL_biceps = {"name" : "F_biceps.L", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_upper_arm.L",\
			"anch_1" : [-0.93, -1, 0.48], "anch_2" : [-0.01, 0, 0.33], "k" : 400, \
			"c" : 40, "kc" : -5, "kl0" : 1}
		FR_biceps = {"name" : "F_biceps.R", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_upper_arm.R",\
			"anch_1" :  [-0.93, 1, 0.48], "anch_2" : [-0.01, 0, 0.33], "k" : 400, \
			"c" : 40, "kc" : -5, "kl0" : 1}
		FL_triceps = {"name" : "F_triceps.L", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_upper_arm.L",\
			"anch_1" : [-0.61, -1, 0.5], "anch_2" : [0.13, 0, 0.978], "k" : 1000, \
			"c" : 100, "kc" : 30, "kl0" : 0.4}
		FR_triceps = {"name" : "F_triceps.R", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_upper_arm.R",\
			"anch_1" :[-0.61, 1, 0.5], "anch_2" : [0.13, 0, 0.978], "k" : 1000, \
			"c" : 100, "kc" : 30, "kl0" : 0.4}
		FL_gastro = {"name" : "F_gastro.L", "debug" : False, "obj_1" : "obj_upper_arm.L", "obj_2" : "obj_wrist.L",\
			"anch_1" : [0.175, 0, 0.752], "anch_2" : [0.085, 0, 0], "k" : 10, \
		...
		## Body
		neck1 = {"name" : "muscle_neck1", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_head",\
			"anch_1" :  [-0.95, 0, 0.47], "anch_2" : [-0.06, 0, -0.71], "k" : 2000, \
			"c" : 100, "kc" : 0, "kl0" : 0.8}
		neck2 = {"name" : "muscle_neck2", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_head",\
			"anch_1" :  [-0.59, 0, 1.4], "anch_2" : [0.117, 0, -0.26], "k" : 2000, \
			"c" : 100, "kc" : 0, "kl0" : 0.8}

		vert1_u = {"name" : "muscle_vert1_up", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_vert.1",\
			"anch_1" :  [-0.186, 0, 0.93], "anch_2" : [-0.01, 0, 0.1], "k" : 4000, \
			"c" : 100, "kc" : 0, "kl0" : 0.8}
		vert1_d = {"name" : "muscle_vert1_down", "debug" : False, "obj_1" : "obj_body.F", "obj_2" : "obj_vert.1",\
			"anch_1" :  [-0.167, 0, 0.65], "anch_2" : [-0.01, 0, -0.1], "k" : 4000, \
			"c" : 100, "kc" : 0, "kl0" : 0.8}

		vert2_u = {"name" : "muscle_vert2_up", "debug" : False, "obj_1" : "obj_vert.1", "obj_2" : "obj_vert.2",\
			"anch_1" :  [0.01, 0, 0.1], "anch_2" : [-0.01, 0, 0.1], "k" : 4000, \
			"c" : 100, "kc" : 0, "kl0" : 0.8}
