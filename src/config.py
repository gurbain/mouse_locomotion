...
class MouseDefConfig(Config):
    ...
    def __init__(self):
        ...
        BL_tensor = {"name": "B_tensor.L", "debug": False, "obj_1": "obj_thigh.L", "obj_2": "obj_shin_lower.L",
                     ...
                     "c": 0, "kc": 0, "kl0": 1, "brain_sig": None}
        BR_tensor = {"name": "B_tensor.R", "debug": False, "obj_1": "obj_thigh.R", "obj_2": "obj_shin_lower.R",
                     "anch_1": [0.01, -0.16, -0.07], "anch_2": [0, 0.09, 0.015], "k": 0,
                     "c": 0, "kc": 0, "kl0": 1, "brain_sig": None}
        ...
        FL_biceps = {"name": "F_biceps.L", "debug": False, "obj_1": "obj_shoulder.L", "obj_2": "obj_upper_arm.L",
                     "anch_1": [-0.93, -1, 0.48], "anch_2": [-0.01, 0, 0.33], "k": 400,
                     "c": 40, "kc": -5, "kl0": 1, "brain_sig": 1}
        FR_biceps = {"name": "F_biceps.R", "debug": False, "obj_1": "obj_shoulder.R", "obj_2": "obj_upper_arm.R",
                     "anch_1": [-0.93, 1, 0.48], "anch_2": [-0.01, 0, 0.33], "k": 400,
                     "c": 40, "kc": -5, "kl0": 1, "brain_sig": 1}
        FL_triceps = {"name": "F_triceps.L", "debug": False, "obj_1": "obj_shoulder.L", "obj_2": "obj_upper_arm.L",
                      "anch_1": [-0.61, -1, 0.5], "anch_2": [0.13, 0, 0.978], "k": 1000,
                      "c": 100, "kc": 30, "kl0": 0.4, "brain_sig": 0}
        FR_triceps = {"name": "F_triceps.R", "debug": False, "obj_1": "obj_shoulder.R", "obj_2": "obj_upper_arm.R",
                      "anch_1": [-0.61, 1, 0.5], "anch_2": [0.13, 0, 0.978], "k": 1000,
                      "c": 100, "kc": 30, "kl0": 0.4, "brain_sig": 0}
        FL_gastro = {"name": "F_gastro.L", "debug": False, "obj_1": "obj_upper_arm.L", "obj_2": "obj_wrist.L",
                     "anch_1": [0.175, 0, 0.752], "anch_2": [0.085, 0, 0], "k": 10,
