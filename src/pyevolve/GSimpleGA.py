...
class GSimpleGA:
   ...
   def setEvaluator(self, evaluator_):
      """ Set the population evaluator """
      self.evaluator = evaluator_

   def setEvaluatorPop(self, pop):
      """ Set the population evaluator """
      pop.evaluator.set(self.evaluator)
      def func(self):
         return
      self.genome.evaluator.set(func)
   ...
   def initialize(self):
      ...
      if self.evaluator:
         self.setEvaluatorPop(self.internalPop)
